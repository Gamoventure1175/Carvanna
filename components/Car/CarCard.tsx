    ...
    return(
        <article className="bg-secondary-default rounded-2xl flex flex-row relative gap font-workSan sm:fllightex-col">
            ...
            <header className="p-2">
                <h1 className="text-lg font-spaceGrotesk font-semibold leading-7">{carData.make} {carData.model}</h1>
                <p className="text-xs">{carData.year}</p>
            </header>
            <section className="p-2">
                <Image  src={carData.image} alt={carData.make + " " + carData.model} width={200} height={200} />
            </section>

...
const Loader = () => {
    return (
        <StyledWrapper >
            <div className="loader min-w-full h-[80vh]">
                <div className="truckWrapper">
                    <div className="truckBody">
                        <svg className="trucksvg" viewBox="0 0 198 93" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M135 22.5H177.264C178.295 22.5 179.22 23.133 179.594 24.0939L192.33 56.8443C192.442 57.1332 192.5 57.4404 192.5 57.7504V89C192.5 90.3807 191.381 91.5 190 91.5H135C133.619 91.5 132.5 90.3807 132.5 89V25C132.5 23.6193 133.619 22.5 135 22.5Z" fill="#eca446" stroke="#282868" strokeWidth={3} />
                            ...
                            <rect x="6.5" y="1.5" width={121} height={90} rx="2.5" fill="#cbcbcb" stroke="#282828" strokeWidth={3} />
                    ...
                    <div className="road" />
                    <svg className="lampPost" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 453.459 453.459" xmlSpace="preserve">

...
export default async function createOAuthAccount(account: Account, profile: Profile) {
    try {

        if (!profile.email) throw new Error('Google Provider did not return an email. Email is required to create a new user for OAuth')
